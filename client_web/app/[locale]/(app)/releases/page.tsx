    ...
    <div style={{ padding: '28px clamp(16px, 4vw, 32px)', fontFamily: 'Inter, system-ui, sans-serif', maxWidth: '1400px' }}>
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
          <div style={{
            ...
            background: 'oklch(0.22 0.05 255)', border: '1px solid oklch(0.34 0.08 255)',
          ...
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '4px', flexWrap: 'wrap' }}>
              ...
              {activeCount > 0 && (
                <span style={{
                  fontSize: '12px', fontWeight: 600, color: 'oklch(0.78 0.14 255)',
                  padding: '2px 9px', borderRadius: '12px',
                  background: 'oklch(0.22 0.04 255)', border: '1px solid oklch(0.34 0.08 255)',
                }}>
      ...
      {releases.length === 0 ? (
        <div style={{
          ...
          borderRadius: '14px', padding: '48px', textAlign: 'center', color: 'oklch(0.52 0.012 260)', fontSize: '13px',
        }}>
          {t('empty')}
        </div>
      ) : (
