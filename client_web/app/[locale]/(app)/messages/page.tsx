...
export default function MessagesPage() {
  ...
  const [selectedContact, setSelectedContact] = useState<TeamMember | null>(
    null,
  );
  ...
  useEffect(() => {
    const handleMessage = (e: WsEvent) => {
      ...
      if (
        selectedContact &&
        (e.from === selectedContact.username ||
          e.to === selectedContact.username)
      ) {
            ...
            contacts.map((contact) => (
              ...
              >
                ...
                <div>
                  ...
                  <div
                    style={{ fontSize: "11px", color: "oklch(0.52 0.012 260)" }}
                  >
                    {contact.role}
                  </div>
                </div>
                ...
                return (
                  <div key={msg.id}>
                    ...
                    >
                      ...
                      >
                        {msgDate.toLocaleTimeString(dateLocale, {
                          hour: "2-digit",
                          minute: "2-digit",
                        })}
                        {msg.read_at && isMe && (
