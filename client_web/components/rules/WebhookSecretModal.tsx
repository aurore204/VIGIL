    ...
    <Modal title={t('title')} onClose={onClose} maxWidth="480px">
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px' }}>
        <div style={{
          ...
          background: 'oklch(0.24 0.04 255)', border: '1px solid oklch(0.38 0.08 255)',
      ...
      <p style={{ fontSize: '13px', color: 'oklch(0.68 0.01 260)', margin: '0 0 18px', lineHeight: 1.55 }}>
        {t('intro')}
      </p>
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: 'oklch(0.16 0.015 260)', border: '1px solid oklch(0.30 0.02 260)',
          borderRadius: '8px', padding: '10px 12px',
        }}>
          <code style={{
            flex: 1, color: 'oklch(0.75 0.14 150)', fontSize: '12.5px',
          ...
          <button
            ...
            style={{
              ...
              border: '1px solid oklch(0.34 0.02 260)', background: 'oklch(0.20 0.016 260)',
              color: 'oklch(0.72 0.01 260)', cursor: 'pointer',
            }}
          >
