      ...
      {timeline.length === 0 ? (
        ...
        >
          {timeline.map((entry) => {
            ...
            const postedReactions = (entry.reactions ?? []).filter(
              (r) => r.count > 0,
            );
                    ...
                    <div style={{ position: "relative", maxWidth: "100%" }}>
                      ...
                      {canPick && isHovered && (
                        ...
                        >
                          {availableReactions.map((emoji) => {
                            ...
                            const hasReacted =
                              existing?.users.includes(currentUsername) ??
                              false;
                            return (
                              <button
                                key={emoji}
                                onClick={() =>
                                  onReaction(entry.id, emoji, hasReacted)
                                }
                      ...
                      <div
                        style={{
                          ...
                          background: isAuthor
                            ? "oklch(0.55 0.16 255)"
                            : "oklch(0.22 0.017 260)",
                          border: isAuthor
                            ? "none"
                            : "1px solid oklch(0.30 0.02 260)",
                          borderRadius: "14px",
                          padding: "10px 14px",
