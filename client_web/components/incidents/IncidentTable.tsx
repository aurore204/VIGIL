        ...
        return (
          <Link
            ...
            style={{
              ...
              textDecoration: "none",
              background: isEven
                ? "oklch(0.185 0.014 260)"
                : "oklch(0.165 0.013 260)",
              borderBottom:
                i < incidents.length - 1
                  ? "1px solid oklch(0.26 0.015 260)"
                  : "none",
              minWidth: "920px",
              transition: "background 0.12s ease",
            }}
            onMouseEnter={(e) => {
              e.currentTarget.style.background = "oklch(0.23 0.02 260)";
            }}
            onMouseLeave={(e) => {
          ...
          >
            ...
            >
              <span
                ...
                style={{
                  ...
                  height: "8px",
                  borderRadius: "50%",
                  background: severityDotColor[incident.severity],
                  flexShrink: 0,
                }}
              />
            ...
            >
              {assignee ? (
                ...
                <span
                  style={{ color: "oklch(0.42 0.01 260)", fontStyle: "italic" }}
                >
                  {t("unassigned")}
                </span>
              )}
