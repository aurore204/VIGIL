...
describe("MemberRow", () => {
  ...
  it('affiche "makeResponder" pour un observer', () => {
    render(
      <MemberRow
        {...baseProps}
        isManager
        member={makeMember({ role: "observer" })}
      />,
    );
  ...
  it('affiche "makeObserver" pour un responder', () => {
    render(
      <MemberRow
        {...baseProps}
        isManager
        member={makeMember({ role: "responder" })}
      />,
    );
  ...
  it('appelle onLeave au clic sur "leave"', async () => {
    ...
    render(
      <MemberRow {...baseProps} isManager={false} isMe onLeave={onLeave} />,
    );
  ...
  it("affiche le badge de rôle", () => {
    render(
      <MemberRow {...baseProps} member={makeMember({ role: "responder" })} />,
    );
