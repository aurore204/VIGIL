...
describe('EditIncidentModal', () => {
  it('pré-remplit les champs avec les valeurs de l\'incident', () => {
    render(<EditIncidentModal incident={incident} onClose={jest.fn()} onSubmit={jest.fn()} />);
  ...
  it('appelle onSubmit avec les valeurs modifiées', async () => {
    ...
    render(<EditIncidentModal incident={incident} onClose={jest.fn()} onSubmit={onSubmit} />);
  ...
  it('appelle onClose au clic sur annuler', async () => {
    ...
    render(<EditIncidentModal incident={incident} onClose={onClose} onSubmit={jest.fn()} />);
